...
export default function LegacyBorderVerifier() {
  ...
  const verify = () => {
    ...
    if (match) {
      setVerificationResult({ success: true, message: "Verification Successful! The physical combination matches the original." });
    } else {
      setVerificationResult({ success: false, message: "Verification Failed! The border proof does not match this photo." });
    }
  };
  ...
  return (
    <div className="component-container">
      <div className="upload-section">
        ...
        <label>3. 1-Pixel Border: <input type="file" accept="image/*" onChange={handleFileUpload(setProof)} /></label>
      </div>
