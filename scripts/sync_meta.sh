...
# Als een lokaal core-bestand verschilt van de Master, maar NIET zojuist gesynchroniseerd is,
# betekent dit dat iemand lokaal in de verkeerde laag heeft geprogrammeerd.
VIOLATIONS=0
